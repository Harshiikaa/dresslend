...
const NavItem = ({ href, text, onClick }) => (
    <a
        href={href}
        onClick={onClick}
        className="text-black-300 hover:bg-gray-700 hover:text-white px-3 py-5 rounded-md text-sm font-medium cursor-pointer"
    >
        {text}
    </a>
);
...
const IconLink = ({ href, IconComponent }) => (
    <a
        href={href}
        className="text-black-300 hover:bg-gray-700 hover:text-white px-3 py-5 rounded-md flex items-center space-x-2 text-sm font-medium"
    >
